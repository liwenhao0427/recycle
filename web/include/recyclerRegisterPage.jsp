...
<form method="post" action="forerecyclerRegister" class="registerForm">
...
<div class="registerDiv">
	...
	<table class="registerTable" align="center">
		<tr>
			<td  class="registerTip registerTableLeftTD">设置相关信息</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="registerTableLeftTD">联系人</td>
			<td  class="registerTableRightTD"><input id="realName" name="realName" placeholder="请填写真实姓名" > </td>
		</tr>	
		<tr>
			<td class="registerTableLeftTD">手机号</td>
			<td  class="registerTableRightTD"><input id="mobile" name="mobile" placeholder="请填写真实手机号" > </td>
		</tr>
