...
<div class="confirmPayPageDiv">
	...
	<div class="confirmPayOrderDetailDiv">
		...
		<table class="confirmPayOrderDetailTable">
			<tr>
				<td>订单编号：</td>
				<td>${o.orderCode} <img width="23px" src="img/site/confirmOrderrecycle.png"></td>
			</tr>
			<tr>
				<td>卖家昵称：</td>
				<td>回收商铺 <span class="confirmPayOrderDetailWangWangGif"></span></td>
			</tr>
			<tr>
				<td>收货信息： </td>
